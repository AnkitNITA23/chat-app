...
const handleSendImage = async (e) =>{
 ...
 useEffect(() => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex items-center gap-3 py-3 px-4 border-b border-stone-500">
        ...
        <img
          ...
          alt="Back"
          className="md:hidden max-w-[28px] cursor-pointer"
        />
      ...
      {/* ================= Messages Area ================= */}
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-4 gap-6">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-black/20 backdrop-blur-md">
        <div className="flex flex-1 items-center gap-3 bg-gray-100/10 px-4 rounded-full">
          <input
    ...
    <div className="flex flex-col items-center justify-center gap-3 text-gray-400 bg-white/10 h-full max-md:hidden">
